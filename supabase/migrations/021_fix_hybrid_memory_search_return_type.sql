-- Fix hybrid_memory_search() score typing for PostgREST RPC calls.
-- The original function returns a numeric expression while declaring
-- rrf_score as double precision, which causes runtime type errors.
